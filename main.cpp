...
int main(void) {
    ...
    int type_sort;
    cout << "Give me the type of algorithm (0: Bubble, 1: Insertion, 2: "
            "Selection): ";
    cin >> type_sort;
...
void arr::sort(void (*f)(int*, unsigned int)) { f(ref_array, size); }

void arr::sort(void (*f)(int*, int, int)) { f(ref_array, 0, (int)(size - 1)); }
